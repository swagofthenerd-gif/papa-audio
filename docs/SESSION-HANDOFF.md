...
6. Open question: the user's own app was not running at 16:15Z on 2026-09-11 with no quit line in its log; nothing in this session targeted it, but tell him.
2. ~~R5~~ done — see above.
