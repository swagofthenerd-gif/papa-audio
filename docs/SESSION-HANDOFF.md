...
4. Remaining video plan: V2 workflows, V3 polish, V4 stability (`docs/video-experience-plan.md`); Speed lane S1–S6/S8; Truth lane leftovers. One dropped video frame per reparent (minimise/restore) is measured and accepted.
5. Open question: the user's own app was not running at 16:15Z on 2026-09-11 with no quit line in its log; nothing in this session targeted it, but tell him.
2. ~~R5~~ done — see above.
